...
<head>
  ...
  <title>Delete Movie Request — FilmoPicks: Your Movie TV Show Recommendations</title>
</head>
    ...
    <div class="form-container">
      <form>
        ...
        <div class="form-group">
          ...
          <textarea id="delete-reason" placeholder="Enter reason here..."></textarea>
        </div>

        <div class="form-actions">
          <button type="button" class="btn btn-cancel">Cancel</button>
          <button type="button" class="btn btn-delete"
            onclick="alert('Requestion Deletion has been sent to the Admins')">Request Deletion</button>
        </div>
      </form>
    </div>
  </div>
