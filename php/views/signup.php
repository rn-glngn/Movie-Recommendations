...
<body>
    <div class="signup-container">
        ...
        <form action="#" method="POST" id="signupForm">
            ...
            <div class="terms-checkbox">
                ...
                <label for="terms">
                    I agree to the <a href="../pages/about.html#terms">Terms of Service</a> and <a
                        href="../pages/about.html#privacy">Privacy Policy</a>
                </label>
            </div>
    ...
    <script>
        ...
        form.addEventListener('submit', function (e) {
            ...
            // If validation passes, you would submit to your server here
            alert('Account created successfully! (This is where you would handle registration)');
            // form.submit();
        });
    </script>
</body>
